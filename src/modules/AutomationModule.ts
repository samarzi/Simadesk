...
export class AutomationModule {
  ...
  show(): void {
    ...
    Promise.all([this.checkExtension(), this.checkServer(), this.loadSavedScans()])
      .then(() => this.render())
      .catch(e => { console.warn('[AutomationModule] init error:', e); this.render(); });
  }
