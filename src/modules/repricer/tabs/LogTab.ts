...
export function renderLog(log: PriceLog[]): string {
            ...
            <tr>
              <td>
                <div style="display:flex;align-items:center;gap:7px;margin-bottom:2px">
                  ...
                  <span style="font-weight:600;font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:200px">${esc(l.productTitle)}</span>
                </div>
                <div style="font-size:10.5px;color:var(--text3)">${esc(l.storeName)}</div>
              </td>
